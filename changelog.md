...
1. 修复打开文章编辑器滚动定位不准确的问题；
2. 修改退出全屏快捷键，从Shift+Esc -> Esc；
3. 优化文件树显示细节；
4. 优化图片放大缩小逻辑，从点击放大改为鼠标移入方法移出缩小；
5. 修复预览模式下图片重复问题；
...
1. 修复工具栏无法创建子文件的问题；
2. 关闭所有编辑窗口后不是退出应用而是显示仓库界面；
3. 重新设计项目界面，将模板与项目合并在同一界面中；
4. 移除仓库界面的模版功能；
5. 修复全屏时界面崩溃的Bug。
